...
import { FiltersUtils } from 'shared/utils/filter-utils';
      ...
      .subscribe(result => {
        ...
        error => {
          this._blockerMessage = new AreaBlockerMessage({
            message: error.message || this._translate.instant('shared.contentShared.categoriesTree.errors.categoriesLoadError'),
            buttons: [{
