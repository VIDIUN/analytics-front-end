...
@Component({
  ...
  providers: [
    VidiunLogger.createLogger('ContributorsTopContributorsComponent'),
...
export class ContributorsTopContributorsComponent extends TopContributorsBaseReportComponent implements OnDestroy {
  ...
  public _reportType = VidiunReportType.topContentContributors;
  
  public topContributors$: BehaviorSubject<{table: VidiunReportTable, compare: VidiunReportTable, busy: boolean, error: VidiunAPIException}> = new BehaviorSubject({table: null, compare: null, busy: false, error: null});
