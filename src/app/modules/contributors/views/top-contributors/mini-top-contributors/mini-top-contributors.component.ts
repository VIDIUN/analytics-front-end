...
import { VidiunAPIException, VidiunReportTable, VidiunReportType } from 'vidiun-ngx-client';
...
@Component({
  ...
  providers: [
    VidiunLogger.createLogger('MiniTopContributorsComponent'),
...
export class MiniTopContributorsComponent extends TopContributorsBaseReportComponent implements OnInit, OnDestroy {
  ...
  @Input() topContributors$: BehaviorSubject<{ table: VidiunReportTable, compare: VidiunReportTable, busy: boolean, error: VidiunAPIException }>;
  ...
  private _handleTable(table: VidiunReportTable, compareTable?: VidiunReportTable): void {
